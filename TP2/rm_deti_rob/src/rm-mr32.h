/**
 * \file rm-mr32.h
 * \brief The MR32 library used in RM
 *
 ...
 * \defgroup loc Localization functions
 */
...
/** \brief wait until a periodic tick (40 ms) is set.
 * \ingroup times
 */
#define waitTick40ms() {while(!tick40ms); tick40ms = 0;}
/** \brief wait until a periodic tick (20 ms) is set.
 * \ingroup times
 */
...
// ****************************************************************************
// Function prototypes
/** \brief Init the Robot's hardware and software.
 * \details ...
 * \ingroup general
 */
void initPIC32(void);
